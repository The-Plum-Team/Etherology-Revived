...
проходят, но полная проверка механик ещё не завершена. Порт Forge 1.20.1 пока ограничен базовой
регистрацией и хранилищем; выпуск артефакта намеренно заблокирован.
