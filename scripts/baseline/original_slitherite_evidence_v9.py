#!/usr/bin/env python3
"""Strict verifier for the immutable original published-0.1.7 Slitherite v9 lane."""
...
PROFILE_RELATIVE_PATH = (
    "scripts/baseline/original-fabric-1.21.1-published-0.1.7-v9.json"
)
HARNESS_VERSION = "1.3.4"
...
class SlitheriteEvidenceError(RuntimeError):
    """Reports a fail-closed Slitherite v9 evidence-contract violation."""


def _fail(message: str, error_type: type[Exception]) -> None:
    raise error_type(f"Original Slitherite v9 evidence: {message}")
...
def validate_evidence(
    *,
    ...
    """Validates one completed immutable v9 capture without trusting the harness."""
    ...
    if (
        ...
        _fail("report did not pass the exact v9 lifecycle", error_type)
