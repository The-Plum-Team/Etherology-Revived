...
MODULE_PATH = BASELINE_DIRECTORY / "original_slitherite_evidence_v6.py"
SPECIFICATION = importlib.util.spec_from_file_location(
    "etherology_original_slitherite_evidence_v6_tested", MODULE_PATH
)
...
class SlitheriteEvidenceV6Tests(unittest.TestCase):
    def validate(
        self,
        scenario_root: Path,
        world: Path,
