...
MODULE_PATH = BASELINE_DIRECTORY / "original_slitherite_evidence_v8.py"
SPECIFICATION = importlib.util.spec_from_file_location(
    "etherology_original_slitherite_evidence_v8_tested", MODULE_PATH
)
...
class SlitheriteEvidenceV8Tests(unittest.TestCase):
    def validate(
        self,
        scenario_root: Path,
        world: Path,
