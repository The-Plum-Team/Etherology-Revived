...
PROFILE_ID = contract_v17.PROFILE_ID
SCENARIO_ID = contract_v17.SCENARIO_ID
TASK_PATH = contract_v17.TASK_PATH
REPORT_SCHEMA = contract_v17.REPORT_SCHEMA
...
REQUIRED_MOD_IDS = contract_v17.REQUIRED_MOD_IDS
FORBIDDEN_MOD_IDS = contract_v17.FORBIDDEN_MOD_IDS
RELOAD_PACK_DIRECTORY = contract_v17.RELOAD_PACK_DIRECTORY
RELOAD_PACK_ENABLED_NAME = contract_v17.RELOAD_PACK_ENABLED_NAME
RELOAD_PACK_RESOURCES = contract_v17.RELOAD_PACK_RESOURCES
ETHER_SOURCE_LISTENER_CLASS = contract_v17.ETHER_SOURCE_LISTENER_CLASS
ENCHANTMENT_REGISTRY_ID = contract_v17.ENCHANTMENT_REGISTRY_ID
NON_TREASURE_TAG_ID = contract_v17.NON_TREASURE_TAG_ID
ENCHANTMENT_IDS = contract_v17.ENCHANTMENT_IDS
ENCHANTMENTS = contract_v17.ENCHANTMENTS
PARTICLE_REGISTRY_ID = contract_v17.PARTICLE_REGISTRY_ID
FEY_PARTICLE_TYPE_CLASS = contract_v17.FEY_PARTICLE_TYPE_CLASS
PARTICLE_IDS = contract_v17.PARTICLE_IDS
PARTICLE_PAYLOAD_FAMILIES = contract_v17.PARTICLE_PAYLOAD_FAMILIES
PARTICLES = contract_v17.PARTICLES
SEAL_TYPE_ORDER = contract_v17.SEAL_TYPE_ORDER
SEAL_TYPES = contract_v17.SEAL_TYPES
MATERIAL_ITEM_REGISTRY_ID = contract_v17.MATERIAL_ITEM_REGISTRY_ID
MATERIAL_ITEM_CLASS = contract_v17.MATERIAL_ITEM_CLASS
MATERIAL_ITEM_NBT_KEYS = contract_v17.MATERIAL_ITEM_NBT_KEYS
MATERIAL_ITEM_MAX_COUNTS = contract_v17.MATERIAL_ITEM_MAX_COUNTS
MATERIAL_ITEM_IDS = contract_v17.MATERIAL_ITEM_IDS
MATERIAL_ITEMS = contract_v17.MATERIAL_ITEMS
MATERIAL_ITEM_CANONICAL_MAX_COUNTS = (
    contract_v17.MATERIAL_ITEM_CANONICAL_MAX_COUNTS
)
MATERIAL_ITEM_CANONICAL_SAVE_REPRESENTATIONS = (
    contract_v17.MATERIAL_ITEM_CANONICAL_SAVE_REPRESENTATIONS
)
METAL_BLOCK_REGISTRY_ID = contract_v17.METAL_BLOCK_REGISTRY_ID
METAL_BLOCK_ITEM_REGISTRY_ID = contract_v17.METAL_BLOCK_ITEM_REGISTRY_ID
METAL_BLOCK_CLASS = contract_v17.METAL_BLOCK_CLASS
BLOCK_ITEM_CLASS = contract_v17.BLOCK_ITEM_CLASS
METAL_BLOCK_NBT_KEYS = contract_v17.METAL_BLOCK_NBT_KEYS
METAL_BLOCK_SPECS = contract_v17.METAL_BLOCK_SPECS
METAL_BLOCK_IDS = contract_v17.METAL_BLOCK_IDS
METAL_BLOCKS = contract_v17.METAL_BLOCKS
METAL_BLOCK_CANONICAL_PROPERTIES = contract_v17.METAL_BLOCK_CANONICAL_PROPERTIES
METAL_BLOCK_CANONICAL_SAVE_REPRESENTATIONS = (
    contract_v17.METAL_BLOCK_CANONICAL_SAVE_REPRESENTATIONS
)
METAL_BLOCK_PLACEMENT_POSITIONS = contract_v17.METAL_BLOCK_PLACEMENT_POSITIONS
METAL_BLOCK_CANONICAL_PLACEMENT_POSITIONS = (
    contract_v17.METAL_BLOCK_CANONICAL_PLACEMENT_POSITIONS
)
METAL_BLOCK_CANONICAL_PLACED_IDS = contract_v17.METAL_BLOCK_CANONICAL_PLACED_IDS
ATTRAHITE_BLOCK_REGISTRY_ID = contract_v17.ATTRAHITE_BLOCK_REGISTRY_ID
ATTRAHITE_ITEM_REGISTRY_ID = contract_v17.ATTRAHITE_ITEM_REGISTRY_ID
ATTRAHITE_BLOCK_ITEM_CLASS = contract_v17.ATTRAHITE_BLOCK_ITEM_CLASS
ATTRAHITE_BLOCK_IDS = contract_v17.ATTRAHITE_BLOCK_IDS
ATTRAHITE_LOOT_TABLE_IDS = contract_v17.ATTRAHITE_LOOT_TABLE_IDS
ATTRAHITE_RECIPE_IDS = contract_v17.ATTRAHITE_RECIPE_IDS
ATTRAHITE_ADVANCEMENT_IDS = contract_v17.ATTRAHITE_ADVANCEMENT_IDS
ATTRAHITE_PROPERTIES = contract_v17.ATTRAHITE_PROPERTIES
ATTRAHITE_TAGS = contract_v17.ATTRAHITE_TAGS
ATTRAHITE_SAVE_REPRESENTATIONS = contract_v17.ATTRAHITE_SAVE_REPRESENTATIONS
ATTRAHITE_PLACEMENT_POSITIONS = contract_v17.ATTRAHITE_PLACEMENT_POSITIONS
ATTRAHITE_PLACED_STATES = contract_v17.ATTRAHITE_PLACED_STATES
ATTRAHITE_STANDARD_LOOT = contract_v17.ATTRAHITE_STANDARD_LOOT
ATTRAHITE_RAW_FORTUNE_LOOT = contract_v17.ATTRAHITE_RAW_FORTUNE_LOOT
ATTRAHITE_RECIPES = contract_v17.ATTRAHITE_RECIPES
ATTRAHITE_ADVANCEMENTS = contract_v17.ATTRAHITE_ADVANCEMENTS
ATTRAHITE_BLOCKS = contract_v17.ATTRAHITE_BLOCKS
ATTRAHITE_ASSERTION_NAMES = contract_v17.ATTRAHITE_ASSERTION_NAMES
ATTRAHITE_ASSERTION_VALUES = contract_v17.ATTRAHITE_ASSERTION_VALUES
FOOD_ITEM_REGISTRY_ID = contract_v17.FOOD_ITEM_REGISTRY_ID
FOOD_ITEM_ID = contract_v17.FOOD_ITEM_ID
FOOD_ITEM_IDS = contract_v17.FOOD_ITEM_IDS
FOOD_ITEM_CLASS = contract_v17.FOOD_ITEM_CLASS
FOOD_ITEM_NBT_KEYS = contract_v17.FOOD_ITEM_NBT_KEYS
FOOD_ITEM_PROPERTIES = contract_v17.FOOD_ITEM_PROPERTIES
FOOD_ITEM_SAVE_REPRESENTATION = contract_v17.FOOD_ITEM_SAVE_REPRESENTATION
FOOD_ITEM_SAVE_REPRESENTATIONS = contract_v17.FOOD_ITEM_SAVE_REPRESENTATIONS
FOOD_ITEMS = contract_v17.FOOD_ITEMS
FOOD_CONSUMPTION_PLAYER_CLASS = contract_v17.FOOD_CONSUMPTION_PLAYER_CLASS
SERVER_STARTED_FOOD_CONSUMPTION = contract_v17.SERVER_STARTED_FOOD_CONSUMPTION
RELOADED_FOOD_CONSUMPTION = contract_v17.RELOADED_FOOD_CONSUMPTION
FOREST_LANTERN_ID = contract_v17.FOREST_LANTERN_ID
FOREST_LANTERN = contract_v17.FOREST_LANTERN
FOREST_LANTERN_ASSERTION_NAMES = contract_v17.FOREST_LANTERN_ASSERTION_NAMES
FOREST_LANTERN_ASSERTION_VALUES = contract_v17.FOREST_LANTERN_ASSERTION_VALUES
INITIAL_ETHER_SOURCE_ENTRIES = contract_v17.INITIAL_ETHER_SOURCE_ENTRIES
RELOADED_ETHER_SOURCE_ENTRIES = contract_v17.RELOADED_ETHER_SOURCE_ENTRIES
canonical_ether_source_entries = contract_v17.canonical_ether_source_entries
EXPECTED_LIFECYCLE = contract_v17.EXPECTED_LIFECYCLE
EXPECTED_ASSERTION_NAMES = contract_v17.EXPECTED_ASSERTION_NAMES
EXPECTED_ASSERTION_VALUES = contract_v17.EXPECTED_ASSERTION_VALUES
PROBE_LOG_PHASES = contract_v17.PROBE_LOG_PHASES
SERVER_LOG_TOKENS = contract_v17.SERVER_LOG_TOKENS
CLIENT_LOG_MARKERS = contract_v17.CLIENT_LOG_MARKERS
CLIENT_CLASS_PATTERN = contract_v17.CLIENT_CLASS_PATTERN
ALLOWED_DEDICATED_SERVER_CLIENT_CLASSES = (
    contract_v17.ALLOWED_DEDICATED_SERVER_CLIENT_CLASSES
)
...
def load_configuration(
    ...
    if (
        expected_manifest_path.stat().st_size != contract_v17.PROFILE_MANIFEST_SIZE
        or sha256_file(expected_manifest_path)
        != contract_v17.PROFILE_MANIFEST_SHA256
    ):
        raise E2EError(
            "The dedicated-server profile bytes differ from the immutable v17 contract"
        )
...
def validate_probe_report(
    ...
    """Validates a probe report through the immutable profile-v17 contract."""
