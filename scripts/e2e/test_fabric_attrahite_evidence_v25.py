...
import client
import evidence
import fabric_attrahite_evidence_v25 as attrahite_evidence
...
class ActiveProfileTests(unittest.TestCase):
    def test_active_profile_is_exact_v25_snapshot(self) -> None:
        ...
        self.assertEqual(
            ...
            (SCRIPT_DIRECTORY / "fabric-1.20.1-profile-v25.json").read_bytes(),
        )

    def test_v20_through_v24_profiles_remain_byte_exact(self) -> None:
        expected = {
