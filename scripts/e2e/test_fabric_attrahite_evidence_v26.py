...
import client
import evidence
import fabric_attrahite_evidence_v25 as historical_attrahite_evidence
import fabric_attrahite_evidence_v26 as attrahite_evidence
...
class ActiveProfileTests(unittest.TestCase):
    def test_active_profile_is_exact_v26_snapshot(self) -> None:
        ...
        self.assertEqual(
            ...
            (SCRIPT_DIRECTORY / "fabric-1.20.1-profile-v26.json").read_bytes(),
        )

    def test_v20_through_v25_profiles_remain_byte_exact(self) -> None:
        expected = {
    ...
    def test_historical_v25_verifier_rejects_active_v26_profile(self) -> None:
        configuration = client.load_configuration()
