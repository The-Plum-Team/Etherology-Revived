...
import client
import evidence
import fabric_attrahite_evidence_v27 as historical_attrahite_evidence
import fabric_attrahite_evidence_v28 as attrahite_evidence
...
class ActiveProfileTests(unittest.TestCase):
    def test_active_profile_is_exact_v28_snapshot(self) -> None:
        ...
        self.assertEqual(
            ...
            (SCRIPT_DIRECTORY / "fabric-1.20.1-profile-v28.json").read_bytes(),
        )

    def test_v20_through_v27_profiles_remain_byte_exact(self) -> None:
        expected = {
    ...
    def test_historical_v27_verifier_rejects_active_v28_profile(self) -> None:
        configuration = client.load_configuration()
    ...
    def test_v25_through_v27_verifier_histories_remain_byte_exact(self) -> None:
        expected = {
    ...
    def test_consumed_v27_failure_history_remains_byte_exact_when_present(
        self,
    ) -> None:
        expected = {
            "scripts/e2e/.state/etherology-e2e-fabric-1.20.1-v27-start.attempted": (
                88,
                "158910e51dcff37763f07d6c35184413d15c90e31a60fe7795c7266cc0c3ee6e",
            ),
            (
                "scripts/e2e/.state/runtimes/etherology-e2e-fabric-1.20.1-v27/"
                "evidence/attrahite-block-registry/reports/report.json"
            ): (
                24_088,
                "6b8cedc9c179f684b8d4849f150e77c4eeaa063bffb0997ae31399631b3606c8",
            ),
            (
                "scripts/e2e/.state/runtimes/etherology-e2e-fabric-1.20.1-v27/"
            ...
            "scripts/e2e/.state/logs/fabric-1.20.1-20260901T014100Z.log": (
                15_440,
                "33cad588502796dd9f09bd4207d63f5faf11608128b1d61deef7bee36321d038",
            ),
            (
                "scripts/e2e/.state/runtimes/etherology-e2e-fabric-1.20.1-v27/"
                ...
                15_003,
                "8300533d9d6ddc48cfcf70a7d4334460a49d83b9f3798167761610a7b831943f",
            ),
        }
        resolved = {
        ...
        if not any(present):
            return
        self.assertTrue(all(present), "The consumed v27 failure history is partial")
    ...
    def test_authoritative_v27_light_samples_define_v28_readiness(self) -> None:
        self.assertEqual(
            {
                "0,121,-8": 15,
                "0,121,0": 15,
...
class ArchiveContractTests(unittest.TestCase):
    ...
    def test_rejects_extra_payload_and_competing_versioned_archive(self) -> None:
        ...
        competing = self.parent / "attrahite-block-registry-v27"
        competing.mkdir()
        with self.assertRaises(client.E2EError):
            attrahite_evidence.validate_archived_evidence(self.archive_root)
    ...
    def test_rejects_missing_live_runtime_fail_closed(self) -> None:
        configuration = client.load_configuration()
        missing = self.parent / "missing-v28-runtime"
