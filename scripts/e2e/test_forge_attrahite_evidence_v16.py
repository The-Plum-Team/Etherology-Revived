...
import forge_attrahite_evidence_v15 as historical_attrahite_evidence
import forge_attrahite_evidence_v16 as attrahite_evidence
...
class ActiveProfileTests(unittest.TestCase):
    def test_active_profile_is_exact_v16_snapshot(self) -> None:
        ...
        self.assertEqual(
            ...
            (SCRIPT_DIRECTORY / "forge-1.20.1-profile-v16.json").read_bytes(),
        )

    def test_rejects_a_linked_v16_snapshot(self) -> None:
        configuration = forge_client.load_configuration()
    ...
    def test_v11_through_v15_profiles_remain_byte_exact(self) -> None:
        expected = {
            11: (
                3644,
    ...
    def test_historical_v15_verifier_rejects_active_v16_profile(self) -> None:
        configuration = forge_client.load_configuration()
