...
import forge_server_food_item_evidence_v14 as evidence
...
def valid_report() -> dict[str, object]:
    ...
    enabled_data_pack_names = sorted(
        ...
        + [contract_v14.RELOAD_PACK_ENABLED_NAME]
    )
    return {
        "schema": contract_v14.REPORT_SCHEMA,
        ...
        "enchantments": {
            "registry_id": contract_v14.ENCHANTMENT_REGISTRY_ID,
            "non_treasure_tag_id": contract_v14.NON_TREASURE_TAG_ID,
            "etherology_enchantment_ids": list(contract_v14.ENCHANTMENT_IDS),
            "peal": copy.deepcopy(contract_v14.ENCHANTMENTS["peal"]),
            "reflection": copy.deepcopy(
                contract_v14.ENCHANTMENTS["reflection"]
            ),
            "non_treasure_etherology_enchantment_ids": list(
                contract_v14.ENCHANTMENT_IDS
            ),
        ...
        "particles": {
            "registry_id": contract_v14.PARTICLE_REGISTRY_ID,
            "capture_error": "",
            "etherology_particle_ids": list(contract_v14.PARTICLE_IDS),
            "payload_families": list(
                contract_v14.PARTICLE_PAYLOAD_FAMILIES
            ),
            "entries": copy.deepcopy(contract_v14.PARTICLES),
            "seal_types": {
                "order": list(contract_v14.SEAL_TYPE_ORDER),
                "codec_round_trips_exact": True,
                "entries": copy.deepcopy(contract_v14.SEAL_TYPES),
            },
            "same_state_at_server_started": True,
            "registry_stable_after_reload": True,
        ...
        "material_items": {
            "registry_id": contract_v14.MATERIAL_ITEM_REGISTRY_ID,
            "capture_error": "",
            "material_item_ids": list(contract_v14.MATERIAL_ITEM_IDS),
            "vanilla_item_class": contract_v14.MATERIAL_ITEM_CLASS,
            "max_counts": contract_v14.MATERIAL_ITEM_CANONICAL_MAX_COUNTS,
            "save_representations": (
                contract_v14.MATERIAL_ITEM_CANONICAL_SAVE_REPRESENTATIONS
            ),
            "entries": copy.deepcopy(contract_v14.MATERIAL_ITEMS),
            "same_state_at_server_started": True,
            "registry_stable_after_reload": True,
            "properties_stable_after_reload": True,
        ...
        "metal_blocks": {
            "block_registry_id": contract_v14.METAL_BLOCK_REGISTRY_ID,
            "item_registry_id": contract_v14.METAL_BLOCK_ITEM_REGISTRY_ID,
            "capture_error": "",
            "metal_block_ids": list(contract_v14.METAL_BLOCK_IDS),
            "metal_block_item_ids": list(contract_v14.METAL_BLOCK_IDS),
            "vanilla_block_class": contract_v14.METAL_BLOCK_CLASS,
            "block_item_class": contract_v14.BLOCK_ITEM_CLASS,
            "properties": contract_v14.METAL_BLOCK_CANONICAL_PROPERTIES,
            "save_representations": (
                contract_v14.METAL_BLOCK_CANONICAL_SAVE_REPRESENTATIONS
            ),
            "entries": copy.deepcopy(contract_v14.METAL_BLOCKS),
            "placement": {
                "capture_error": "",
                "positions": copy.deepcopy(
                    contract_v14.METAL_BLOCK_PLACEMENT_POSITIONS
                ),
                "placed_block_ids": {
                    identifier: identifier
                    for identifier in contract_v14.METAL_BLOCK_IDS
                },
                "exact": True,
                "stable_after_reload": True,
            },
        ...
        "food_items": {
            "registry_id": contract_v14.FOOD_ITEM_REGISTRY_ID,
            "capture_error": "",
            "food_item_ids": list(contract_v14.FOOD_ITEM_IDS),
            "vanilla_item_class": contract_v14.FOOD_ITEM_CLASS,
            "properties": contract_v14.FOOD_ITEM_PROPERTIES,
            "save_representations": (
                contract_v14.FOOD_ITEM_SAVE_REPRESENTATIONS
            ),
            "entries": copy.deepcopy(contract_v14.FOOD_ITEMS),
            "same_state_at_server_started": True,
            "registry_stable_after_reload": True,
            "properties_stable_after_reload": True,
            "stack_nbt_stable_after_reload": True,
        ...
        "food_consumption": {
            "server_started": copy.deepcopy(
                contract_v14.SERVER_STARTED_FOOD_CONSUMPTION
            ),
            "reloaded": copy.deepcopy(
                contract_v14.RELOADED_FOOD_CONSUMPTION
            ),
        ...
        "ether_sources": {
            "listener_class": contract_v14.ETHER_SOURCE_LISTENER_CLASS,
            "resource_directory": "ether_sources",
            "initial": {
                "capture_error": "",
                "entries": copy.deepcopy(
                    contract_v14.INITIAL_ETHER_SOURCE_ENTRIES
                ),
            },
            "server_started": {
                "capture_error": "",
            ...
            "reloaded": {
                "capture_error": "",
                "entries": copy.deepcopy(
                    contract_v14.RELOADED_ETHER_SOURCE_ENTRIES
                ),
            },
        ...
        "reload": {
            "pack_directory": contract_v14.RELOAD_PACK_DIRECTORY,
            "pack_resources": list(contract_v14.RELOAD_PACK_RESOURCES),
            "enabled_pack_name": contract_v14.RELOAD_PACK_ENABLED_NAME,
        ...
        "lifecycle": list(contract_v14.EXPECTED_LIFECYCLE),
...
def build_fixture(root: Path) -> Fixture:
    ...
    profile_snapshot = (
        evidence.REPOSITORY_ROOT / contract_v14.PROFILE_SNAPSHOT_RELATIVE_PATH
    )
...
class ContractOwnershipTests(unittest.TestCase):
    def test_v14_archive_contract_does_not_import_the_mutable_runner(self) -> None:
        evidence_source = Path(evidence.__file__).read_text(encoding="utf-8")
        contract_source = Path(contract_v14.__file__).read_text(encoding="utf-8")
        ...
        self.assertEqual(219, len(contract_v14.EXPECTED_ASSERTION_NAMES))
        self.assertEqual(219, len(contract_v14.EXPECTED_ASSERTION_VALUES))
        self.assertEqual(
            Path(
        ...
        self.assertEqual(
            contract_v14.PROFILE_MANIFEST_SIZE,
        ...
        self.assertEqual(
            {"enum_name", "as_string"},
            set(contract_v14.SEAL_TYPES["empty"]),
        )
        for seal_name in ("keta", "rella", "via", "clos"):
            self.assertEqual(
                ...
                set(contract_v14.SEAL_TYPES[seal_name]),
            )
        self.assertEqual(14, len(contract_v14.MATERIAL_ITEM_IDS))
        self.assertEqual(
            16,
            contract_v14.MATERIAL_ITEM_MAX_COUNTS[
        ...
        self.assertTrue(
            all(
                ...
                for identifier, max_count in (
                    contract_v14.MATERIAL_ITEM_MAX_COUNTS.items()
                )
        ...
        self.assertEqual(
            ...
            contract_v14.METAL_BLOCK_SPECS["etherology:azel_block"],
        )
        self.assertEqual(
            {
                "hardness": 5.0,
            ...
            contract_v14.METAL_BLOCK_SPECS["etherology:ebony_block"],
        )
        self.assertEqual(
            {
                "hardness": 3.0,
            ...
            contract_v14.METAL_BLOCK_SPECS["etherology:ethril_block"],
        )
        self.assertEqual(
            {
        ...
        self.assertEqual(
            ...
            contract_v14.FOOD_ITEMS["etherology:forest_lantern_crumb"],
        )
        self.assertEqual(
            "EtherFoodStart",
            contract_v14.SERVER_STARTED_FOOD_PLAYER_NAME,
        )
        self.assertEqual(
            "EtherFoodReload",
            contract_v14.RELOADED_FOOD_PLAYER_NAME,
        )
...
class LiveEvidenceTests(unittest.TestCase):
    def test_exact_live_runtime_passes(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            self.assertEqual(219, summary.assertion_count)
            self.assertEqual(
    ...
    def test_registry_enchantment_and_particle_contracts_are_exact(self) -> None:
        ...
        for field, replacement in cases:
            with self.subTest(field=field), tempfile.TemporaryDirectory() as temporary:
                ...
                with self.assertRaisesRegex(evidence.EvidenceError, "v14 contract"):
                    evidence.validate_live_runtime(
                        fixture.runtime,
                        fixture.profile,
                        expected_runtime=fixture.runtime,
    ...
    def test_material_item_registry_stack_and_reload_contracts_are_exact(
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            fixture = build_fixture(Path(temporary_directory))
            report_path = fixture.scenario / "reports" / "report.json"
            assertion_index = contract_v14.EXPECTED_ASSERTION_NAMES.index(
    ...
    def test_food_item_registry_properties_nbt_and_reload_are_exact(
        ...
        item_id = contract_v14.FOOD_ITEM_ID
        cases = (
            (
                "registry id",
    ...
    def test_food_consumption_native_state_and_reload_are_exact(self) -> None:
        ...
        reloaded_cases = (
            ...
            (
                "fresh player uuid",
                "player_uuid",
                contract_v14.SERVER_STARTED_FOOD_PLAYER_UUID,
            ),
            (
                "fresh player name",
                "player_name",
    ...
    def test_reload_command_pack_and_stability_contract_are_exact(self) -> None:
        cases = (
            ...
            (
                "pack resources",
                "pack_resources",
                list(reversed(contract_v14.RELOAD_PACK_RESOURCES)),
            ),
    ...
    def test_all_219_assertions_must_pass_in_exact_order_and_value(self) -> None:
        mutations = (
...
class ArchiveEvidenceTests(unittest.TestCase):
    ...
    def test_resealed_v14_reload_report_tampering_is_rejected(self) -> None:
        cases = (
            (
                "schema downgrade",
                lambda report: report.__setitem__("schema", 2),
            ...
            (
                ...
                lambda report: report["reload"][
                    "enabled_data_pack_names"
                ].remove(contract_v14.RELOAD_PACK_ENABLED_NAME),
            ),
            (
    ...
    def test_resealed_v14_reload_log_tampering_is_rejected(self) -> None:
        cases = (
            (
    ...
    def test_archive_requires_exact_destination_and_food_item_v14_name(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary_directory:
            fixture = build_fixture(Path(temporary_directory))
            ...
            with self.assertRaisesRegex(
                evidence.EvidenceError,
                "repository path|food-item profile v14",
            ):
                evidence.validate_archived_evidence(
                    wrong_name,
    ...
    def test_archive_rejects_older_and_newer_food_item_directories(
        self,
    ) -> None:
        for competing_name in (
            "food-item-registry-server-v13",
            "food-item-registry-server-v15",
        ):
