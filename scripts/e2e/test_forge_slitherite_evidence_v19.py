...
import forge_client
import forge_slitherite_evidence_v19 as forge_slitherite_evidence
...
class ForgeSlitheriteEvidenceV19Tests(
    ...
    historical_verifier_relative_path = (
        "scripts/e2e/forge_slitherite_evidence_v18.py"
    )
    historical_verifier_sha256 = (
        "d336da49ca6bc9a3332af29201b558f57a390b6d98fb4b970eb6fbd58c31798c"
    )

    def test_v18_contract_files_remain_size_and_sha_exact(self) -> None:
        ...
        protected_files = (
            ...
            (
                "scripts/e2e/forge_slitherite_run_contract_v18.py",
                1879,
                "1c80460ac05bcbed1a905859e3c26199ad92e0ae11ecd5c54cb98502c92fd6ce",
            ),
            (
                "scripts/e2e/test_forge_slitherite_evidence_v18.py",
                11617,
                "fcb6fb8840e0b59404b477a7c7f1cf414b87910bd140d7c13b1f08cde6aef6c3",
            ),
        )
        for relative_path, expected_size, expected_sha256 in protected_files:
            with self.subTest(relative_path=relative_path):
                path = repository_root / relative_path
                self.assertTrue(path.is_file())
                self.assertFalse(path.is_symlink())
                self.assertEqual(expected_size, path.stat().st_size)
                self.assertEqual(expected_sha256, support.sha256_file(path))


class ForgeSlitheriteRunContractV19Tests(unittest.TestCase):
    def setUp(self) -> None:
        self.configuration = forge_client.load_configuration()

    def test_evidence_and_controller_share_v19_contract_constants(self) -> None:
    ...
    def test_exact_harness_pin_checks_size_and_sha256(self) -> None:
        content = b"final-remapped-forge-slitherite-v19-harness"
