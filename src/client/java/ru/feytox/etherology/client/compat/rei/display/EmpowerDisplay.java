...
public class EmpowerDisplay extends BasicDisplay {
    ...
    public EmpowerDisplay(List<EntryIngredient> inputs, List<EntryIngredient> outputs, EmpowerRecipe recipe) {
        super(inputs, outputs, Optional.of(recipe.getId()));
        this.recipe = recipe;
    }
    
    public static EmpowerDisplay of(EmpowerRecipe recipe) {
        ...
        return new EmpowerDisplay(inputs, outputs, recipe);
    }
