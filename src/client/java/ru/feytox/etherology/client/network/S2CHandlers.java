...
public class S2CHandlers {
    ...
    public static void receiveRemoveBlockEntity(RemoveBlockEntityS2C packet, MinecraftClient client) {
        if (client.world == null) return;
        client.world.removeBlockEntity(packet.pos());
    }

    public static void receiveRedstoneStream(RedstoneLensStreamS2C packet, MinecraftClient client) {
    ...
    public static void receiveSwitchBlockAnim(SwitchBlockAnimS2C packet, MinecraftClient client) {
        if (client.world == null) return;
    ...
    public static void receiveStopBlockAnim(StopBlockAnimS2C packet, MinecraftClient client) {
        if (client.world == null) return;
    ...
    public static void receiveStartBlockAnim(StartBlockAnimS2C packet, MinecraftClient client) {
        if (client.world == null) return;
        var be = client.world.getBlockEntity(packet.pos());
