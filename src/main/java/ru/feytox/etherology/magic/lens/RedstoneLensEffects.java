...
public class RedstoneLensEffects extends PersistentState {
    ...
    public static RedstoneLensEffects getServerState(ServerWorld world) {
        ...
        RedstoneLensEffects effects = manager.getOrCreate(RedstoneLensEffects::createFromNbt,
                RedstoneLensEffects::new, Etherology.MOD_ID + "_redstone_lens");
        effects.markDirty();
        return effects;
    }

    public static RedstoneLensEffects createFromNbt(NbtCompound nbt) {
